...
{
	std::string e[9] = {"html", "css", "jpg", "png", "webp", "ico", "txt", "mp3", "mp4"};
	std::string t[9] = {"text/html", "text/css", "image/jpg", "image/png", "image/webp", "image/ico", "text/plain", "audio/mp3", "video/mp4"};
	for(int i = 0; i < 9; ++i)
	{
